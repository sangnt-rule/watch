...
('admin_resource_recruitment', 'recruitment', '7500', @module);
Set @resource = 0;
...
('admin_privilege_hr_benefit', 'hr-benefit', 200, @resource),
('admin_privilege_recruitment_listing', 'index', 150, @resource),
('admin_privilege_edit', 'edit', 100, @resource)
;