...
(
  ...
  feature_category_content text not null,
  ...
  feature_category_updated_at timestamp on update current_timestamp,
  ...
  constraint `fk_feature_category_category_id_locale` foreign key (fk_locale) references locale(locale_id)
) ENGINE=InnoDb AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT 'Danh muc cap 1 - Diem tham quan';